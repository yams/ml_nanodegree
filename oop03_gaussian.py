...
# 
# The unit tests expect a file in the same directory called 'oop03_numbers.txt'
...
# Unit tests to check the solution
...
class TestGaussianClass(unittest.TestCase):
    ...
    def test_meancalculation(self):
        self.gaussian.read_data_file('oop03_numbers.txt', True)
    ...
    def test_stdevcalculation(self):
        ...
        self.gaussian.read_data_file('oop03_numbers.txt', False)
