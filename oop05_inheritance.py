...
# 
# The following code contains a Clothing parent class and two children 
# classes: Shirt and Pants.
# 
# Your job is to code a class called Blouse. Read through the code and fill 
# out the TODOs. Then check your work with the unit tests at the bottom 
# of the code.
